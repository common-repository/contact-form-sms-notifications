<?php 
/**
* Plugin Name: Contact Form SMS Notifications     
* Description: Using Contact Form 7 SMS integration - ALL BULK SMS
* Version: 1.2
* Author: Piyush Patel
* Author URI: https://profiles.wordpress.org/piyushmca/
* Text Domain: https://www.allbulksms.in/
* License: GPL-2.0+
* License URI: http://www.gnu.org/licenses/gpl-2.0.txt 
* Text Domain: contact-form-sms-notifications
...
class Contact_Form_Sms_Integration_abn{
	...
	private function define_constant(){
		$this->define('Contact_FormSI_NAME',__('Contact Form SMS Integration','cf7-sms-integration-abs')); # Plugin Name
